...
#Short shell script to run replay jobs on JLab batch farm for Hall A GEn data
...
analyzer -b -q 'replay_GEn.C+('$runnum','$maxevents','$firstevent','\"$prefix\"','$firstsegment','$maxsegments')'
