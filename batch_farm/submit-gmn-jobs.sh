...
work_flow='seeds_gmnreplay_sbs4'
...
for ((i=0; i<=$2; i++))
do
    fnameout_pattern='/farm_out/seeds/bbcal_gmn_'$runnum'_segment'$i'.out'
    ...
    script='/work/halla/sbs/seeds/shell/batch_farm/run-gmn-replay.sh'
